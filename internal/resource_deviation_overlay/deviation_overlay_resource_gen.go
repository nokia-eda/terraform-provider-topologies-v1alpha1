...
package resource_deviation_overlay
...
func DeviationOverlayResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DeviationOverlay$"), ""),
				},
				Default: stringdefault.StaticString("DeviationOverlay"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DeviationOverlay",
			},
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DeviationOverlaySpec defines the desired state of DeviationOverlay",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DeviationOverlayStatus defines the observed state of DeviationOverlay",
			},
		},
	}
}

type DeviationOverlayModel struct {
