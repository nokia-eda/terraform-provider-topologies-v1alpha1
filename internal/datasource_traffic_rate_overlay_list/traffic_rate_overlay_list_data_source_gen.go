...
package datasource_traffic_rate_overlay_list
...
func TrafficRateOverlayListDataSourceSchema(ctx context.Context) schema.Schema {
...
type TrafficRateOverlayListModel struct {
