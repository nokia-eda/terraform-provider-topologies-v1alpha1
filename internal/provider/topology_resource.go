...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-topologies/internal/resource_topology"
	"github.com/nokia/eda/apps/terraform-provider-topologies/internal/tfutils"
)

const (
	create_rs_topology = "/apps/topologies.eda.nokia.com/v1alpha1/topologies"
	read_rs_topology   = "/apps/topologies.eda.nokia.com/v1alpha1/topologies/{name}"
	update_rs_topology = "/apps/topologies.eda.nokia.com/v1alpha1/topologies/{name}"
	delete_rs_topology = "/apps/topologies.eda.nokia.com/v1alpha1/topologies/{name}"
)

var (
	_ resource.Resource                = (*topologyResource)(nil)
	_ resource.ResourceWithConfigure   = (*topologyResource)(nil)
	_ resource.ResourceWithImportState = (*topologyResource)(nil)
)
...
func (r *topologyResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_topology"
}

func (r *topologyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_topology.TopologyResourceSchema(ctx)
}

func (r *topologyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_topology.TopologyModel
	...
	err = r.client.Create(ctx, create_rs_topology, nil, reqBody, &result)
	...
	err = r.client.Get(ctx, read_rs_topology, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_topology,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *topologyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_topology, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *topologyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_topology, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *topologyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
