...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-topologies/internal/datasource_topology"
...
const read_ds_topology = "/apps/topologies.eda.nokia.com/v1alpha1/topologies/{name}"
