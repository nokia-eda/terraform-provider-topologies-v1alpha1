...
var _ provider.Provider = (*topologiesProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &topologiesProvider{version: ver}
	}
}

type topologiesProvider struct {
	version string
}
...
func (p *topologiesProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *topologiesProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *topologiesProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "topologies-v1alpha1"
	resp.Version = p.version
}

func (p *topologiesProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewDeviationOverlayDataSource,
		NewDeviationOverlayListDataSource,
		NewLldpOverlayDataSource,
		NewLldpOverlayListDataSource,
		NewNetworkTopologyDataSource,
		NewNetworkTopologyListDataSource,
		NewResourceListDataSource,
		NewTopologyDataSource,
		NewTopologyGroupingDataSource,
		NewTopologyGroupingListDataSource,
		NewTopologyListDataSource,
		NewTrafficRateOverlayDataSource,
		NewTrafficRateOverlayListDataSource,
		NewWorkflowGetInputsRespElemDataSource,
	}
}

func (p *topologiesProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewDeviationOverlayResource,
		NewLldpOverlayResource,
		NewNetworkTopologyResource,
		NewTopologyResource,
		NewTopologyGroupingResource,
		NewTrafficRateOverlayResource,
	}
}
