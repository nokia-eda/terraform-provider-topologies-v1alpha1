...
package datasource_network_topology_list
...
func NetworkTopologyListDataSourceSchema(ctx context.Context) schema.Schema {
...
type NetworkTopologyListModel struct {
