...
package datasource_deviation_overlay_list
...
func DeviationOverlayListDataSourceSchema(ctx context.Context) schema.Schema {
...
type DeviationOverlayListModel struct {
