...
package resource_traffic_rate_overlay
...
func TrafficRateOverlayResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TrafficRateOverlay$"), ""),
				},
				Default: stringdefault.StaticString("TrafficRateOverlay"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TrafficRateOverlay",
			},
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TrafficRateOverlaySpec defines the desired state of TrafficRateOverlay",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TrafficRateOverlayStatus defines the observed state of TrafficRateOverlay",
			},
		},
	}
}

type TrafficRateOverlayModel struct {
