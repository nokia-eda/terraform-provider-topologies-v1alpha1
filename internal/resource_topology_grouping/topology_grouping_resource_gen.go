...
package resource_topology_grouping
...
func TopologyGroupingResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TopologyGrouping$"), ""),
				},
				Default: stringdefault.StaticString("TopologyGrouping"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TopologyGrouping",
			},
...
type TopologyGroupingModel struct {
