---
page_title: "topologies-v1alpha1 Provider"
---

# topologies-v1alpha1 Provider

This provider is used to interact with the resources provided by the **topologies-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
